...
Getting started Customizations Learn what you can customize in the Polotno editor interface and functionality What can I customize in Polotno editor?  
...
The Store API allows you to implement all of these features, ensuring your data flow fits seamlessly with your infrastructure. Overview Introduction to Polotno - a JavaScript library for creating canvas editors Editor configuration Configure uploads, translations, fonts, and color presets in Polotno
